...
public class Projects2EmployeesRESTTest extends AbstractRESTTest {
    ...
    public void test02_ReadAllProjetcs() {
        ...
        // #2
        target = createBasicAuthenticationClientForDefaultAdmin(RESTConfig.PROJECTS2EMPLOYEES_PATH);
        target = target.path(RESTConfig.EMPLOYEES_PATH);
     ...
     */
    private Employee helpCreateEmployee(String fistName, String lastName, EmployeeRole role) {
        // cretate employee
        Employee retEmployee = createEmployee(fistName, lastName);
        ...
        Employee2Role employeeRole = createEmployee2Role(retEmployee, role);
     ...
     */
    private Project helpCreateProject(String projectID, Employee owner) {
        Assume.assumeNotNull(owner);
        Project retProject = createProject(projectID, owner);
     ...
     * @param projectID The {@code primary key}.
     */
    private void helpDeleteProject(Project project) {
